...
const LandlordDashboard = () => {
    ...
    return (
        <>{
            !data?.isLoading && <TabContext value={value} >
                <Box sx={{ borderBottom: 1, display: 'flex', width: '100%', justifyContent: 'center' }}>
                    <TabList className='bg-white' onChange={handleChange} aria-label="Rentopia Landlord Tabs"
                ...
                <TabPanel value="1">
                    <CreateListingForm fetch={data?.fetchData} user={user as IAuthState} ></CreateListingForm>
